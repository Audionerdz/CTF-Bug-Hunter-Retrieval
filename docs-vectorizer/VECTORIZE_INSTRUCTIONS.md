...
#### Sintaxis:
```bash
/root/.openskills/venv/bin/python3 /root/.openskills/vectorize_canonical_openai.py <ruta_a_directorio>
```
...
```bash
/root/.openskills/venv/bin/python3 /root/.openskills/vectorize_canonical_openai.py /home/kali/Desktop/RAG/cheatsheets
```

**Vectorizar chunks con ruta relativa:**
```bash
/root/.openskills/venv/bin/python3 /root/.openskills/vectorize_canonical_openai.py ./mis_chunks
```
...
#### Sintaxis:
```bash
/root/.openskills/venv/bin/python3 /root/.opencode/skills/vectorizer/executables/vectorize_simple.py <ruta_a_directorio>
```
...
**Vectorizar chunks:**
```bash
/root/.openskills/venv/bin/python3 /root/.opencode/skills/vectorizer/executables/vectorize_simple.py /home/kali/Desktop/RAG/cheatsheets
```
...
#### Sintaxis:
```bash
/root/.openskills/venv/bin/python3 /root/.opencode/skills/vectorizer/executables/vectorize_universal.py <directorio_1> [<directorio_2> ...]
```
...
```bash
/root/.openskills/venv/bin/python3 /root/.opencode/skills/vectorizer/executables/vectorize_universal.py cheatsheets
```

**Vectorizar múltiples directorios:**
```bash
/root/.openskills/venv/bin/python3 /root/.opencode/skills/vectorizer/executables/vectorize_universal.py cheatsheets GAVEL FACTS_CHUNKS
```
...
/root/.openskills/venv/bin/python3 /root/.openskills/vectorize_canonical_openai.py /home/kali/mis_chunks
...
# 3. Vectoriza con OpenAI (mejor calidad)
/root/.openskills/venv/bin/python3 /root/.openskills/vectorize_canonical_openai.py /ruta/mis_chunks
...
/root/.openskills/venv/bin/python3 /root/.opencode/skills/vectorizer/executables/vectorize_simple.py /ruta/mis_chunks
```
...
2. **Vectoriza con:** `/root/.openskills/venv/bin/python3 /root/.openskills/vectorize_canonical_openai.py <tu_ruta>`
